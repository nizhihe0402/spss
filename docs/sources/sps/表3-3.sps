...
SELECT IF ( ID是否一致 = 1). 
EXECUTE.
SAVE OUTFILE='D:\2025常见病\数据审核\XX省份\第一次反馈库\表3-3\01-表3-3-ID不一致.sav' 
  /COMPRESSED.
...
EXECUTE.
SAVE OUTFILE='D:\2025常见病\数据审核\XX省份\第一次反馈库\表3-3\02-表3-3-ID重复.sav' 
  /COMPRESSED.
...
EXECUTE.
RECODE A01 (41 thru 43=0) (SYSMIS=1) (ELSE=1) INTO 年级编码缺失或异常.
EXECUTE.
...
EXECUTE.
DATASET ACTIVATE  infoxx. 
SAVE OUTFILE='D:\2025常见病\数据审核\XX省份\第一次反馈库\表3-3\03-表3-3-基本信息缺失.sav' 
  /COMPRESSED.
...
EXECUTE. 
DATASET ACTIVATE  bbb. 
SAVE OUTFILE='D:\2025常见病\数据审核\XX省份\第一次反馈库\表3-3\表3-3-清理后.sav' 
  /COMPRESSED.
