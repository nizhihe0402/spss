/*
 ...
 Source Schema         : healthdetection_2026

 Target Server Type    : MySQL
 Target Server Version : 50736 (5.7.36-log)
 File Encoding         : 65001

 Date: 06/07/2026 14:01:28
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 2673 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `app_upload_data_log`  (
  ...
  `upload_time` datetime NULL DEFAULT NULL COMMENT '上传时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3041 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_approve_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 186 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '审批详情表，记录审批操作的历史信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for bus_desk_chair_standard
-- ----------------------------
DROP TABLE IF EXISTS `bus_desk_chair_standard`;
CREATE TABLE `bus_desk_chair_standard`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `model_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '课桌椅型号',
  `desk_height_mm` int(11) NOT NULL COMMENT '桌面高(mm)',
  `seat_height_mm` int(11) NOT NULL COMMENT '座面高(mm)',
  `standard_height_cm` decimal(5, 1) NOT NULL COMMENT '标准身高(cm)',
  `height_min_cm` decimal(5, 1) NULL DEFAULT NULL COMMENT '学生身高范围下限(cm)，为空表示不限',
  `height_max_cm` decimal(5, 1) NULL DEFAULT NULL COMMENT '学生身高范围上限(cm)，为空表示不限',
  `sort_order` int(11) NOT NULL COMMENT '排序',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_desk_chair_model_no`(`model_no`) USING BTREE,
  INDEX `idx_desk_chair_height_range`(`height_min_cm`, `height_max_cm`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '中小学课桌椅调整标准' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_doctor_answer`  (
  ...
  INDEX `table_id`(`table_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21194 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_doctor_answer_intervene`  (
  ...
  INDEX `student_id`(`student_id`) USING BTREE,
  INDEX `table_id`(`table_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3405 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_doctor_answer_retest`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `student_id`(`student_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2553 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_doctor_answer_retest_log`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `student_id` bigint(20) NOT NULL COMMENT '问卷code码',
  `project_id` bigint(20) NOT NULL,
  `table_id` bigint(20) NOT NULL COMMENT '表id',
  `checktype_id` bigint(20) NOT NULL COMMENT '检查项id',
  `times` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '体检评估管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_informed`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `student_id` bigint(20) NULL DEFAULT NULL COMMENT '学生编码',
...
CREATE TABLE `bus_logic_relation`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`project_id`, `table_id`, `question_id`, `option_id`, `id`) USING BTREE
...
CREATE TABLE `bus_option`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`project_id`, `table_id`, `question_id`, `option_id`) USING BTREE
...
CREATE TABLE `bus_parent_view_not_confirm`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 32620 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '家长查看未确认学生详情' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_parent_view_statistics`  (
  ...
  `create_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21645 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '家长查看统计中间表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_project`  (
  ...
  `intervene_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '是否综合干预项目（0-不是；1-是）',
...
CREATE TABLE `bus_question`  (
  ...
  PRIMARY KEY (`project_id`, `table_id`, `question_id`) USING BTREE,
  INDEX `table_id`(`table_id`) USING BTREE
...
CREATE TABLE `bus_student`  (
  `student_id` bigint(20) NOT NULL COMMENT '学生编码(year+原编码,19位)',
  ...
  `real_id` bigint(20) NULL DEFAULT NULL COMMENT '原学生编码(15位)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 12509 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_student_answer_intervene`  (
  ...
  INDEX `student_id`(`student_id`) USING BTREE,
  INDEX `table_id`(`table_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3300 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `bus_student_backup`  (
  `student_id` bigint(20) NOT NULL COMMENT '16位编码',
  `student_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学生姓名',
  `sex` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `national` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '民族',
  `birthday` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '出生日期',
...
) ENGINE = InnoDB AUTO_INCREMENT = 27852 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 35642 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 64957 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `log_statistics`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1432944 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3166 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 123 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
